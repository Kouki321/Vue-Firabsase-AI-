  ...
  methods: {
    deletePost() {
      ...
      this.$store.dispatch("deletePost", this.post.blogID);
       //   this.$store.dispatch("deleteFromthestoreImage",this.post.blogPhotoName)

     this.$store.dispatch("deleteFromthestoreImage",this.post.blogID)
   
    toast.success('delete post  successfully!');
    } catch (error) {
          toast.error('Errordelete post  successfully!:', error);
        }
    },
    editBlog() {
